...
# Hypothesis Test
# ---- TODO: make your edits here ----
test_statistic, p_value = st.ttest_1samp(your_team_df ['elo_n'], 1607.22)
...
# Hypothesis Test
test_statistic, p_value = st.ttest_1samp(your_team_df ['pts'],  105.13)
...
# Hypothesis Test
# ---- TODO: make your edits here ----
test_statistic, p_value = proportions_ztest(counts, nobs, 0.6818)
